    ...
    render(){
        return(
            ...
            <Row className="row">
                ...
                <Card.Body>
                <Card.Title>
                <h1 style={{color:'blue'}}>Confirmed Cases
                ...
                <Card.Body>
                <Card.Title><h1 style={{color:'green'}}>Recovered Cases
            ...
            <br />
            <div className="deceased"><i>No. of Deaths: {this.props.deceased}(+{this.props.daily_deceased})</i></div>
